...
Two codebases shape your questions:
1. **Dude gem** (this repo) — the product we build. Your examples should reflect what Dude can do.
2. **Claude Code** at ~/dev/ext/claude-code/ (READ ONLY) — the platform we wrap. Your assumptions often hide here — "does CC actually expose that?"
...
- Examples should reflect what's possible from the outside — we build around CC in the dude gem
