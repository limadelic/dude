...
Dude::Dudes::Dudes, all: []))
  ...
  describe 'Active model background' do
    ...
    it 'has black text on yellow for readability' do
      ...
      models = {
        'claude-haiku-4-5' => { 'metrics' => { 'successful_requests' => 40, 
'spend' => 5.0 } },
        'claude-opus-4-6' => { 'metrics' => { 'successful_requests' => 30, 
'spend' => 5.0 } },
        'claude-sonnet-4-6' => { 'metrics' => { 'successful_requests' => 30, 
'spend' => 5.0 } }
      }
  ...
  describe 'Model multiplier' do
    ...
    it 'shows ¹⁰ for model with 1 request' do
      models = { 'claude-opus-4-6' => { 'metrics' => { 
