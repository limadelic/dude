...
module StatusLine
  class Runner
    ...
    SUPERSCRIPTS = Format::SUPERSCRIPTS
    BG_MAP = Format::BG_MAP
    WHITE = Format::WHITE
    JETBRAINS = Format::JETBRAINS
    ...
    def create_dudes_instance
      StatusLine::Dudes.new(@session, dudes_list, @cwd, context_percentage)
    end
    ...
    def context_section
      StatusLine::Context.new(@session, context_percentage).to_s
    end
    ...
    def spend_section
      StatusLine::Spend.new(activity_data).to_s
    end
    ...
    def models_section
      StatusLine::Models.new(@session, activity_data).to_s
    end
